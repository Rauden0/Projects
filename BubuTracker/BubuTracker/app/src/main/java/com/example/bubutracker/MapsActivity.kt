...
import com.example.bubutracker.backgroundTracking.LocationService
import com.example.bubutracker.client.AddTrackingDto
import com.example.bubutracker.client.RetrofitClient
import com.example.bubutracker.client.TrackedLocationDto
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private fun refreshTrackedLocations() {
        RetrofitClient.apiService.getTrackedLocations()
    ...
    private fun showAddTrackingDialog() {
        ...
        input.hint = getString(R.string.email_address)
    ...
    private fun addTracking(email: String) {
        RetrofitClient.apiService.addTracking(AddTrackingDto(email))
    ...
    private fun logout() {
        ...
        BubuTrackerApp.sessionManager.clear()
        startActivity(Intent(this, LoginActivity::class.java))
        finish()
    }
