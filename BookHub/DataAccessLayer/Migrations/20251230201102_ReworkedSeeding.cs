    ...
    public partial class ReworkedSeeding : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Aut voluptatum rerum et dicta.", false, 2, true, 2, 407.65298f, 19 },
                    { 2, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Alias et laborum minus vel.", false, 3, true, 3, 168.76695f, 14 },
                    { 3, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Nobis eum aut sed ut.", false, 2, false, 3, 1936.345f, 8 },
                    { 4, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Porro veniam sed harum aperiam.", false, 1, true, 2, 1279.6255f, 22 },
                    { 5, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Explicabo corporis pariatur ipsum laboriosam.", false, 3, true, 3, 1113.7904f, 27 },
                    { 6, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Non expedita officia molestias possimus.", false, 3, true, 3, 499.48932f, 19 },
                    { 7, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Itaque hic voluptatem est sequi.", false, 3, true, 3, 755.0846f, 12 },
                    { 8, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Ipsa culpa porro animi rerum.", false, 3, true, 3, 1253.31f, 15 },
                    { 9, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Est sequi eius voluptatem ratione.", false, 1, false, 3, 2548.2385f, 12 },
                    { 10, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Eius voluptas inventore fuga hic.", false, 3, true, 3, 1670.0005f, 11 },
                    { 11, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Optio dicta officiis beatae et.", false, 2, true, 1, 1714.1338f, 23 },
                    { 12, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Possimus ut ad nisi voluptas.", false, 2, true, 1, 1712.2909f, 19 },
                    { 13, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Voluptatem eius et et temporibus.", false, 3, true, 2, 1327.7565f, 14 },
                    { 14, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Eos nihil quae sunt fugiat.", false, 1, false, 3, 683.9251f, 19 },
                    { 15, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Sed quo rerum doloribus non.", false, 1, true, 3, 299.58423f, 12 },
                    { 16, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Officia vero et officiis corrupti.", false, 3, true, 1, 807.416f, 21 },
                    { 17, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Animi consequuntur quasi dignissimos voluptates.", false, 3, true, 2, 416.40527f, 19 },
                    { 18, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Corrupti fugiat magni eaque molestiae.", false, 2, true, 3, 1314.1494f, 15 },
                    { 19, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Sit eaque expedita nesciunt est.", false, 1, false, 1, 1285.9926f, 16 },
                    { 20, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Perferendis voluptate aut et et.", false, 3, true, 3, 1383.8208f, 25 }
                });
