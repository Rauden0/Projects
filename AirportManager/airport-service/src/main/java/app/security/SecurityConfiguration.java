    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests(x -> x
                        ...
                        .requestMatchers(HttpMethod.GET, "/airports", "/airports/**", "/airplanes", "/airplanes/**")
                        .hasAnyAuthority(COMMERCIAL_DEPT, SCHEDULE_COORDINATOR, HR_AND_MANAGEMENT)
                        // Manage airports and airplanes
                        .requestMatchers("/airports", "/airports/**", "/airplanes", "/airplanes/**")
                        .hasAnyAuthority(COMMERCIAL_DEPT)
